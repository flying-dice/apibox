...
- **claude** (2026-09-12T04:20:00.000Z): **Presentation superseded by card 30.** The collapse behaviour described here is current and correct, but the raised card surface this card shipped was rejected on review — a collapsed row cost about 90px for one line of text. Card 30 removed the surface entirely in favour of flat hairline-separated rows at about 36px. The scroll-spy limitation noted here was then fixed under card 31. Read the behaviour as current and the presentation as history.
