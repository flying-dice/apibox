...
agent: claude
live: false
status: Security schemes parsed and rendered via the existing component
progress: 100
...
- [x] Add security scheme fields to the AsyncAPI document model
- [x] Parse `components.securitySchemes` and server `security`
